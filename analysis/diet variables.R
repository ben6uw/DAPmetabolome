...
library(ggpubr)
library(ggplot2)
library(pspearman) # enables P < 2.2e-16 for spearman
...
cb <-read.csv('/Users/ben/Library/CloudStorage/GoogleDrive-brharrison2000@gmail.com/My Drive/Documents/DogAgingProject/data/2023_release/DAP_2023_CODEBOOK_v1.0.csv')
head(cb)

load('/Users/ben/Library/CloudStorage/GoogleDrive-brharrison2000@gmail.com/My Drive/Documents/DogAgingProject/data/2023_release/DAP_2023_HLES_dog_owner_v1.0.RData')
